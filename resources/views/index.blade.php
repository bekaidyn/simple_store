...
<head>
   ...
   <link rel="stylesheet" href="{{ asset('images/fevicon.png') }}">
            ...
            <div class="containt_main">
               <div id="mySidenav" class="sidenav">
                  ...
                  <a href="{{ url('index.blade.php') }}">Home</a>
                     <a ref="{{ url('fashion.blade.php') }}">Fashion</a>
                     <a ref="{{ url('electronic.blade.php') }}">Electronic</a>
                     <a ref="{{ url('jewellery.blade.php') }}">Jewellery</a>
               </div>
                           ...
                           <div class="box_main">
                              ...
                              <p class="price_text">Price <span style="color: #262626;">$ 30</span></p>
                                 <div class="tshirt_img">
                                    <img src="{{ url('uploads/images/dress.png') }}">
                                 </div>
